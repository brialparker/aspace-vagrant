...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision 'shell', inline: 'firewall-cmd --zone=public --add-port=8080/tcp --permanent'
  config.vm.provision 'shell', inline: 'firewall-cmd --zone=public --add-port=8089/tcp --permanent'
  config.vm.provision 'shell', inline: 'firewall-cmd --zone=public --add-port=8090/tcp --permanent'
